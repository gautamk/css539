...
Dunlop et al \cite{dunlop_mt6d:_2011} leverage the vast address space ($2^{128}$) address space of IPv6 to move the source and destination IP addresses mid-session based on a pre-agreed pattern to limit an attacker's ability to intercept or interfere with a TCP session.  
